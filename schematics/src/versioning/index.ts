    ...
    paths.forEach(path => {
        ...
        if (tree.exists(path)) {
            ...
            if (file !== null) {
                ...
                if (json.peerDependencies && json.peerDependencies["@danielhokanson/ng-dynamic-forms-core"] !== undefined) {
                    json.peerDependencies["@danielhokanson/ng-dynamic-forms-core"] = `^${version}`;
                }
