...
describe('DynamicPrimeNGChipsComponent test suite', () => {
    ...
    beforeEach(waitForAsync(() => {
        TestBed.configureTestingModule({
            ...
            testElement = debugElement.query(By.css(`p-inputtags[id="${testModel.id}"]`)) ||
                debugElement.query(By.css('p-inputtags'));
        });
    }));
    ...
    it('should initialize correctly', () => {
        ...
        expect(component.pChips instanceof InputTags).toBe(true);
        expect(component.viewChild instanceof InputTags).toBe(true);
    ...
    it('should have a p-inputtags element', () => {
