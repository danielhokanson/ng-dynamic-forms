...
describe('DynamicBootstrapFormComponent test suite', () => {
    ...
    beforeEach(waitForAsync(() => {
        TestBed.configureTestingModule({
            imports: [DynamicBootstrapFormComponent],
    ...
    it('should render a form control container for every model', () => {
        const containerElements = debugElement.queryAll(By.css('dynamic-bootstrap-form-control'));
