...
@Component({
    ...
    imports: [ReactiveFormsModule, NgClass, NgTemplateOutlet, DynamicNGxBootstrapFormControlContainerComponent]
})
...
@Component({
    ...
    standalone: true,
    changeDetection: ChangeDetectionStrategy.Eager,
    imports: [ReactiveFormsModule, NgClass, DynamicNGxBootstrapFormControlContainerComponent]
})
